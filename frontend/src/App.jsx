...
// ─────────────────────────────────────────────
// ASSESSMENT LANDING — clean static version
// ─────────────────────────────────────────────
  ...
  const features = [
    {
      ...
      desc: "Up to 15 questions tailored to your answers — no irrelevant ones.",
      color: "#0d9488",
      bg: "#f0fdfa",
    },
    {
      icon: "shield",
      title: "22 Diseases Covered",
      desc: "Covers tropical and common diseases prevalent across West Africa.",
      color: "#3b82f6",
      bg: "#eff6ff",
    },
    {
      ...
      desc: "Home care, tests to consider, and when to see a doctor.",
      color: "#8b5cf6",
      bg: "#f5f3ff",
    },
  ];
    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div className="page-body" style={{ flex: 1 }}>
        <div className="card card-p mb-4">
          ...
          <div
            className="t-subtitle mt-3 italic"
            style={{ fontSize: 12 }}
          >
